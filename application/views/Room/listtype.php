	...
	<div class="box-search">
		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                <input type="text" id="txtRoomTypeName" class="form-control" name="txtRoomTypeName">
			</div>			
            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5 text-right">
...
<div id="box-manage" style="display: none;">
	<form id="form-manage" name="form-manage" method="post" action="" enctype="multipart/form-data">		
		<div class="row">
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-5 text-right">
				<label class="" style="font-weight: bold;font-size: 16px;"><?php echo $this->lang->line('type_room'); ?></label>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-5 text-right">
